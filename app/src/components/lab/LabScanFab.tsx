...
export function LabScanFab() {
  ...
  return (
    <View style={[styles.host, { bottom }]} pointerEvents="box-none">
      <Pressable onPress={openScanner} accessibilityRole="button" accessibilityLabel="Scan QR code">
        <LinearGradient
          colors={[...fabColors]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
          style={styles.fab}
        >
          <MaterialCommunityIcons name="qrcode-scan" size={28} color={theme.text.onPrimary} />
        </LinearGradient>
      </Pressable>
    </View>
  )
