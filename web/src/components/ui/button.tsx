  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        /** Honey / amber gradient — primary marketing & auth submit actions. */
        honey:
          "rounded-xl border-0 font-semibold text-primary-foreground shadow-lg shadow-primary/25 honey-gradient hover:opacity-95 active:scale-[0.99] disabled:opacity-50",
        /** Outlined accent — newsletter, secondary marketing actions. */
        warmOutline:
          "rounded-lg border-2 border-accent bg-transparent font-accent text-xs font-semibold uppercase tracking-[0.14em] text-accent hover:bg-accent/10",
      },
      size: {
