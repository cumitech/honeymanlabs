...
export type CameroonRegion = {
  code: CameroonRegionCode;
  name: string;
  capital: string;
  agroZone: "Forest" | "Highland" | "Savannah" | "Sudano-Sahel";
};

export const CAMEROON_REGIONS: readonly CameroonRegion[] = [
  { code: "AD", name: "Adamawa", capital: "Ngaoundere", agroZone: "Savannah" },
  { code: "CE", name: "Centre", capital: "Yaounde", agroZone: "Forest" },
  { code: "EA", name: "East", capital: "Bertoua", agroZone: "Forest" },
  { code: "FN", name: "Far North", capital: "Maroua", agroZone: "Sudano-Sahel" },
  { code: "LT", name: "Littoral", capital: "Douala", agroZone: "Forest" },
  { code: "NO", name: "North", capital: "Garoua", agroZone: "Sudano-Sahel" },
  { code: "NW", name: "North-West", capital: "Bamenda", agroZone: "Highland" },
  { code: "WE", name: "West", capital: "Bafoussam", agroZone: "Highland" },
  { code: "SU", name: "South", capital: "Ebolowa", agroZone: "Forest" },
  { code: "SW", name: "South-West", capital: "Buea", agroZone: "Forest" },
] as const;
...
export const CAMEROON_DIVISIONS_BY_REGION: Readonly<Record<CameroonRegionCode, readonly string[]>> = {
  ...
  EN: ["Diamare", "Logone et Chari", "Mayo Danay", "Mayo Kani", "Mayo Sava", "Mayo Tsanaga"],
...
export const REGION_OPTIONS = CAMEROON_REGIONS.map((region) => ({
  value: region.code,
